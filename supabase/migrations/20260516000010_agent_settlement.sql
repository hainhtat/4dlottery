-- Agent view: tickets sold, commission earned, amount due to admin (per round)
...
BEGIN
  ...
  RETURN jsonb_build_object(
    ...
    'current', (
      ...
      GROUP BY r.id, r.name, r.status, r.ticket_price, r.closes_at
    )
  );
END;
$$;

GRANT EXECUTE ON FUNCTION get_agent_settlement TO authenticated;
